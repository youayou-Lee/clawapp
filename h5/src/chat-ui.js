...
const SVG_TRASH = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"/></svg>`
...
export function createChatPage() {
  ...
  page.innerHTML = `
    <div class="chat-header">
      ...
      <button class="clear-btn" id="clear-btn" title="清空对话">${SVG_TRASH}</button>
